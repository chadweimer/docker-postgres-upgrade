...
Check to make sure the version you're trying to upgrade from is available in the [Alpine packages](https://pkgs.alpinelinux.org/packages?name=postgresql1%3F&branch=v3.20&repo=&arch=x86_64&maintainer=). Here is an few example:
